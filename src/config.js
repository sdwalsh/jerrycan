...
if (!exports.HOSTNAME) {
  console.warn('Warn: CSRF checks are disabled' +
                'since there is no HOSTNAME environment' +
                'variable provided');
}

exports.MESSAGES_PER_PAGE = Number.parseInt(process.env.MESSAGES_PER_PAGE, 10)
                            || 10;
exports.USERS_PER_PAGE = Number.parseInt(process.env.USERS_PER_PAGE, 10)
                            || 10;
